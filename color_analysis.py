...
class FabricRollingVideo:
    ...
    def analyze_video(self):
        """
        Analyze the frames of the generated video for color uniformity.
        - Regional Color Gradation: Shows the sum of pixel values for Left, Middle, and Right regions over time.
        - Full Fabric Color Uniformity: Shows global color intensity of the entire fabric over time.
        """
        # Open the video
